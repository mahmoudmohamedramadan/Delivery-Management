...
Route::group(
  ['middleware' => 'auth', 'namespace' => 'Delegate'],
  static function () {
    Route::prefix('/index')->group(static function () {
      ...
      Route::get('delegate/{id}', 'DelegateController@show');
      Route::livewire('delegate/{id}/edit', 'edit-delegate')
        ->section('title')
        ->section('content');
      Route::delete('delegate/{id}', 'DelegateController@destroy');
      Route::post(
        'delegate/delegates-order-relation',
        'DelagateDBRelation@DelegateOrderRelation'
      );
    });
  }
);
...
Route::group([
  'middleware' => 'auth', 'namespace' => 'Order', 'prefix' => '/index'
], function () {
...
Route::group([
  'middleware' => 'auth', 'namespace' => 'Expense', 'prefix' => '/index'
], function () {
...
Route::get(
  ...
  'Socailite.LoginController@handleProviderCallback'
);
...
Route::delete(
  '/index/{user}/notifications',
  'Notification\NotificationController@destroy'
);
