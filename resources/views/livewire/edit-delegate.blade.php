...
<form wire:submit.prevent="update({{ $delegate_id }})">
  ...
  <label>
    ...
    <input type="text" wire:model.lazy="name" class="input" autocomplete="off"
  ...
  <label>
    ...
    <input type="text" wire:model.lazy="phone" class="input" autocomplete="off"
  ...
  <label>
    ...
    <input type="text" wire:model.debounce.800ms="motor_size" class="input"
           autocomplete="off"
  ...
  <label>
    ...
    <input type="date" wire:model.lazy="made_date" class="input"
           autocomplete="off">
    <div class="line-box">
      <div class="line"></div>
    </div>
