    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <a rel="alternate" hreflang="{{ $localeCode }}"
                href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" class="content-center"
...
<form action="{{ url(LaravelLocalization::setLocale() . '/contact-us/submit') }}" method="POST">
    ...
    <label>
        ...
        <input type="email" class="input" value="{{ old('email') }}" name="email" autocomplete="off"
            placeholder="{{ __('contact-us.inputs.Email') }}">
        <div class="line-box">
            <div class="line"></div>
        </div>
