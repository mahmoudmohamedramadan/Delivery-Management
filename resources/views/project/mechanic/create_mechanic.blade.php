...
@section('title', 'Create Mechanic | Delivery Management')
...
<input type="button" value="Create Car" class="button btn btn-primary" onclick="location.href= '/index/car/create' ">
@endsection