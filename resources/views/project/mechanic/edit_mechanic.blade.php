...
<title>Edit {{ $mechanic->name }} | Delivery Management</title>
...
<form id="ajax" action="/index/mechanic/{{ $mechanic->id }}" method="post">
    ...
    <label>
        ...
        <input id="id" type="text" value="{{ $mechanic->id ?? old('id') }}" name="id" class="input text-red-700
    ...
    <label>
        ...
        <input type="text" class="input" value="{{ $mechanic->name ?? old('name') }}" name="name" autocomplete="off"
    ...
    <label>
        ...
        <textarea name="address" class="input" style="min-height: 100px;max-height: 200px" placeholder="Mechanic
