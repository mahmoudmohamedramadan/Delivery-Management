@extends('layouts.app')@section('title', 'Create Expense | Delivery Management')
@section('ajax')
  <script>
  ...
  <form id="ajax" action="{{ url('/index/expense') }}" method="POST">
    ...
    <label>
      ...
      <input id="id" type="text" id="id"
             value="{{ \App\Models\Expense::max('id') + 1 }}" name="id"
    ...
    <label>
      ...
      <input type="text" id="type" value="{{ old('type') }}" name="type"
             class="input" placeholder="Enter Expense Type" autocomplete="off">
      <div class="line-box">
        <div class="line"></div>
      </div>
      @error('type')<span
    ...
    <label>
      ...
      <input type="text" id="info" value="{{ old('info') }}" name="info"
    ...
    <label>
      ...
      <input type="text" id="sum" value="{{ old('sum') }}" name="sum"
             class="input" placeholder="Enter Sum Of Expense" autocomplete="off"
             maxlength="4">
      <div class="line-box">
        <div class="line"></div>
      </div>
    ...
    <label>
      ...
      <textarea name="notes" id="notes" vlaue="{{ old('notes') }}"
                placeholder="Enter Expense Notes" class="input"
    ...
    <input type="button" value="Save Data Ajax" id="save-ajax"
           class="btn btn-success">
  </form>
  <input type="button" value="Show Expenses Data" class="button btn btn-light"
         onclick="location.href= '/index/expense' ">
@endsection
