@extends('layouts.app')@section('title', 'Create Company | Delivery Management')
    @push('scripts')
        <script>
    ...
    <form id="ajax">
      @csrf
        ...
        <label>
            ...
            <input type="text" value="{{ old('product_name') }}" name="product_name" class="input" autocomplete="off" placeholder="Enter Product Name">
            <div class="line-box">
                <div class="line"></div>
            </div>
